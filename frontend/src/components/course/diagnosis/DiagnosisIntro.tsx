  ...
  return (
    /*
      ...
      **上から順に置いて、余りは下にまとめる。**
      ...
      一度、余りを上下へ配ったことがある（メタの下と道の下に、伸びる
      隙間を 2 : 3 で置いた）。下だけに白が溜まると画面が途中で
      終わって見える、という理由だったが、実機で見ると**メタと道の
      あいだに空きができる**ほうが読みにくかった。上下に散らすと、
      並んでいるもの同士の近さが端末の高さで変わる——「この3つの札は
      この図の説明だ」というまとまりが、背の高い端末ほど薄くなる。

      近さは意味を持つ。だから要素どうしの間隔は固定し、**余りは
      本文と下のボタンのあいだ**へ置く。そこが空くのは、押すものと
      読むものが離れているというだけのことで、読みにくさにはならない。
    */
