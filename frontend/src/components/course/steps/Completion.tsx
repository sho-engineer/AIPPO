      ...
      {reusablePrompt && (
        <section
          /*
            ...
            この札・成果物のぜんぶは載らない。**消してはいない**
            ——「このレッスンの記録」の一枚が同じ3行を持っていて、
            そちらではコピーもできる。
            ...
            境目は 780px
            ------------
            はじめ 700px にしていたが、**Pixel 5（393×727）で 9px
            あふれた**。あの高さでこの画面に渡せるのは 306px で、
            祝いの絵 128・できるようになったこと 52・覚えた技 27・
            この札 60・成果物 104 を足すと届かない。

            700 と 727 のあいだに端末が挟まっていたので、実測が通る
            ところまで上げる。iPhone のふつうの持ち方（390×844）は
            これでも入る。
          */
          className="mt-2 hidden shrink-0 rounded-card border border-brand-line
                     bg-brand-soft/60 px-3.5 py-2.5
                     [@media(min-height:780px)]:block"
