...
const STEPS = [
  {
    number: "1",
    /*
      本数は、**診断の画面が言っている数と合わせる。**

      ここは長く「3つの質問」だった。実際は5問で、診断の入口自身が
      「5つの質問で、今のAIの使い方を見てみよう」と言い、進み具合も
      「質問 3 / 5」と出す。**最初に見た約束だけが違っていた。**

      少なく言って多く出すのは、いちばん効く裏切り方になる。3問の
      つもりで始めた人は、4問目で「まだあるのか」と思う。
    */
    title: "5つの質問に答える",
    body: "いまの使い方と、困っていることを選ぶだけ。",
    Icon: IconChecklist,
  },
  {
    number: "2",
          ...
          <div className="mt-6 flex flex-col items-center">
            ...
            {/*
              **押した先で起きることだけを書く。**
              ...
              ここは「3つの質問に答えるだけ。」だった。数が違ううえ
              （実際は5問）、押した先は診断ではなく**ホーム**なので、
              二重に約束を外していた。押した人は質問を待ち構えたまま
              知らない画面に着く。

              いま書くのは、押す前に本当に知りたいこと——登録が
              要らないことと、すぐ始められること。診断そのものは
              ホームから入る（この画面が入口を約束しない）。
            */}
            <p className="mt-3 animate-rise-in text-xs text-ink-muted [animation-delay:0.85s]">
              登録は必要ありません。ひらいてすぐ、はじめられます。
            </p>
