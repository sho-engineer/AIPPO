 ...
 * 表示する言語。
 *
 * **いまは選んだ内容を覚えるだけで、画面はまだ切り替わらない。**
 *
 * 訳文を1語も用意していないのに「英語にできます」と見せると、
 * 選んだ人は壊れていると受け取る。翻訳の仕組み（文言の外出しと辞書）は
 * これから入れる。それまでは、選べること自体は残したうえで、
 * まだ効かないことを設定画面ではっきり書く（SettingsPage）。
 *
