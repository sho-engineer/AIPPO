  ...
  steps: [
    {
      ...
      */
      /*
        短くした。「いつもの使い方に近いものを選んでね」は、まだ
        選択肢が1つも出ていない画面で**選び方の説明**をしていて、
        吹き出しの中で2行に折り返していた。答え方の不安に答える、と
        いう役はそのまま、言うことを1つに絞る。
      */
      poMessage: "いつもの使い方を教えてね",
      poEmotion: "question",
    ...
    /* ── Q4 ── ミニ問題2。目的に応じて使い方を選べるか ── */
    {
      ...
      /*
        **ルールを、数で言い切る。**
        ...
        前は「3つの場面に、合いそうな使い方をひとつずつ。」だった。
        「ひとつずつ」が場面につくのか使い方につくのかが読みで決まり、
        「3つ選ぶ」のか「3つの中から1つ選ぶ」のかが分かれる
        ——実際、場面をまたいで同じ使い方を選んでよいのかが
        画面のどこにも書いていなかった。

        場面ごとに1つ、とそのまま書く。

        **1行に収める。** 「同じものを選んでも大丈夫」も足していたが、
        402px で2行になり、3つ目の枠の最後の札が画面から切れた（実測）。
        その安心はポーの一言がもう言っている（「迷ったら、近いと
        思うほうで大丈夫です。」）——同じことを2か所で言わない。
      */
      instruction: "場面ごとに1つずつ選びます。",
