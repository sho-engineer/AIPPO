...
const LESSON_1: Lesson = {
  ...
  */
  ...
  /*
    後の例は**短くしていない**。むしろ元より長い。
    分かりやすさのために言葉を足しているところを、そのまま見せる。
  */
  afterExample:
    "AIが文章を読むときは、「どの言葉が、どの言葉と関係しているか」を自分で見つけています。\nたとえば「それ」が何を指しているのかを、文の中から探して結びつけるイメージです。\nしかもこの結びつけを、一度だけでなく何通りもの見方で同時におこないます。だから長い文章でも、意味を取りちがえにくくなります。",
  ...
  steps: buildLessonFlow({
    ...
    /*
      ...
      どれを選んでも中身は同じ「分かりやすくして」。言い回しを選ぶことで、
      自分が頼んだという手応えだけを持ってもらう。
    */
    quickTitle: "AIに何て頼む？",
    ...
    quickOptions: [
      { value: "分かりやすくして", label: "分かりやすくして" },
      { value: "かんたんな言葉にして", label: "かんたんな言葉にして" },
      { value: "かみくだいて説明して", label: "かみくだいて説明して" },
    ],
    /*
      既定値を置かない。
